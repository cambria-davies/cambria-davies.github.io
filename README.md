...
// Cost breakdown: boat €1,530 + transit log €320 + fuel ~€175 + marinas ~€100 = ~€2,125 fixed (split)
// Provisioning ~€50/person/day x 7 days = €350/person
const costData = {
  fixed: { rental: 1530, transit: 320, fuel: 175, marinas: 100 },
  perPersonPerDay: 50, // provisioning
  provisionDays: 7,
  crewOptions: [4, 6, 8]
};
